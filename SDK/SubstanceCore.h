...
public:
	...
	bool bIsFrozen; // 0x158 (1)

	void SetInputString(struct FString Identifier, struct FString Value); // Function SubstanceCore.SubstanceGraphInstance.SetInputString(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xCD3340>
	void SetInputInt(struct FString Identifier, struct TArray<int32_t>& InputValues); // Function SubstanceCore.SubstanceGraphInstance.SetInputInt(Final|Native|Public|HasOutParms|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xCD31F0>
	bool SetInputImg(struct FString InputName, struct Object Value); // Function SubstanceCore.SubstanceGraphInstance.SetInputImg(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xCD3100>
	void SetInputFloat(struct FString Identifier, struct TArray<float>& InputValues); // Function SubstanceCore.SubstanceGraphInstance.SetInputFloat(Final|Native|Public|HasOutParms|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xCD2FB0>
	void SetInputColor(struct FString Identifier, struct FLinearColor& Color); // Function SubstanceCore.SubstanceGraphInstance.SetInputColor(Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xCD2E70>
	void SetInputBool(struct FString Identifier, bool Bool); // Function SubstanceCore.SubstanceGraphInstance.SetInputBool(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xCD2D40>
	struct FSubstanceIntInputDesc GetIntInputDesc(struct FString Identifier); // Function SubstanceCore.SubstanceGraphInstance.GetIntInputDesc(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xCD2710>
	struct FSubstanceInstanceDesc GetInstanceDesc(); // Function SubstanceCore.SubstanceGraphInstance.GetInstanceDesc(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xCD25E0>
	enum class ESubstanceInputType GetInputType(struct FString InputName); // Function SubstanceCore.SubstanceGraphInstance.GetInputType(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xCD24F0>
	struct FString GetInputString(struct FString Identifier); // Function SubstanceCore.SubstanceGraphInstance.GetInputString(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xCD23C0>
	struct TArray<struct FString> GetInputNames(); // Function SubstanceCore.SubstanceGraphInstance.GetInputNames(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xCD22E0>
	struct TArray<int32_t> GetInputInt(struct FString Identifier); // Function SubstanceCore.SubstanceGraphInstance.GetInputInt(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xCD21B0>
	struct TArray<float> GetInputFloat(struct FString Identifier); // Function SubstanceCore.SubstanceGraphInstance.GetInputFloat(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xCD2080>
	struct FLinearColor GetInputColor(struct FString Identifier); // Function SubstanceCore.SubstanceGraphInstance.GetInputColor(Final|Native|Public|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xCD1F80>
	bool GetInputBool(struct FString Identifier); // Function SubstanceCore.SubstanceGraphInstance.GetInputBool(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xCD1E90>
	struct FSubstanceFloatInputDesc GetFloatInputDesc(struct FString Identifier); // Function SubstanceCore.SubstanceGraphInstance.GetFloatInputDesc(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xCD1BB0>
	struct UMaterialInstanceDynamic GetDynamicMaterialInstance(struct FName Name, struct UMaterial InParentMaterial); // Function SubstanceCore.SubstanceGraphInstance.GetDynamicMaterialInstance(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xCD1A20>
};
...
public:
	...
	enum class ESubstanceGenerationMode GenerationMode; // 0x80 (1)
};
...
public:
	...
	enum class ESubstanceEngineType SubstanceEngine; // 0x38 (1)
	enum class EDefaultSubstanceTextureSize DefaultSubstanceOutputSizeX; // 0x39 (1)
	enum class EDefaultSubstanceTextureSize DefaultSubstanceOutputSizeY; // 0x3A (1)
...
public:
	...
	enum class TextureAddress AddressX; // 0x108 (1)
	enum class TextureAddress AddressY; // 0x109 (1)
	bool bCooked; // 0x10A (1)
};
...
struct FSubstanceInputDesc {
	struct FString Name; // 0x0 (16)
	enum class ESubstanceInputType Type; // 0x10 (1)
};
...
inline bool USubstanceGraphInstance::SetInputImg(struct FString InputName, struct Object Value) {
...
inline void USubstanceGraphInstance::SetInputBool(struct FString Identifier, bool Bool) {
...
inline enum class ESubstanceInputType USubstanceGraphInstance::GetInputType(struct FString InputName) {
	...
	struct GetInputType_Params {
		struct FString InputName;
		enum class ESubstanceInputType ReturnValue;
...
inline bool USubstanceGraphInstance::GetInputBool(struct FString Identifier) {

...
public:
	...
	enum class EDatasmithAreaLightActorType LightType; // 0x220 (1)
	enum class EDatasmithAreaLightActorShape LightShape; // 0x221 (1)
	struct FVector2D Dimensions; // 0x224 (8)
	float Intensity; // 0x22C (4)
	enum class ELightUnits IntensityUnits; // 0x230 (1)
	struct FLinearColor Color; // 0x234 (16)
	float Temperature; // 0x244 (4)
	struct UTextureLightProfile IESTexture; // 0x248 (8)
	bool bUseIESBrightness; // 0x250 (1)
	float IESBrightnessScale; // 0x254 (4)
	struct FRotator Rotation; // 0x258 (12)
	float SourceRadius; // 0x264 (4)
	float SourceLength; // 0x268 (4)
	float AttenuationRadius; // 0x26C (4)
	float SpotlightInnerAngle; // 0x270 (4)
	float SpotlightOuterAngle; // 0x274 (4)
};
...
public:
	...
	bool bMergeNodes; // 0x48 (1)
	bool bOptimizeDuplicatedNodes; // 0x49 (1)
	bool bRemoveInvisibleNodes; // 0x4A (1)
	bool bSimplifyNodeHierarchy; // 0x4B (1)
	bool bImportVar; // 0x4C (1)
	struct FString VarPath; // 0x50 (16)
	bool bImportPos; // 0x60 (1)
	struct FString PosPath; // 0x68 (16)
	bool bImportTml; // 0x78 (1)
...
public:
	...
	bool bMergeNodes; // 0x48 (1)
	bool bOptimizeDuplicatedNodes; // 0x49 (1)
	bool bImportMats; // 0x4A (1)
	struct FString MatsPath; // 0x50 (16)
	bool bImportVar; // 0x60 (1)
	bool bCleanVar; // 0x61 (1)
	struct FString VarPath; // 0x68 (16)
	bool bImportLightInfo; // 0x78 (1)
	struct FString LightInfoPath; // 0x80 (16)
	bool bImportClipInfo; // 0x90 (1)
...
public:
	...
	struct TArray<struct ULevelSequence> ImportedSequences; // 0x220 (16)

	void PlayLevelSequence(struct ULevelSequence SequenceToPlay); // Function DatasmithContent.DatasmithImportedSequencesActor.PlayLevelSequence(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xF06690>
};
...
public:
	...
	char bVisible : 1; // 0x30 (1)
	char pad_30_1 : 7; // 0x30 (1)
	char CastShadows : 1; // 0x34 (1)
	char pad_31_1 : 7; // 0x31 (1)
	char pad_32_0 : 1; // 0x32 (1)
	char bUseTemperature : 1; // 0x34 (1)
	char pad_32_2 : 6; // 0x32 (1)
	char pad_33_0 : 2; // 0x33 (1)
	char bUseIESBrightness : 1; // 0x34 (1)
	char pad_33_3 : 5; // 0x33 (1)
...
public:
	...
	char bEnabled : 1; // 0x70 (1)
	char bUnbound : 1; // 0x70 (1)
};
...
public:
	...
	struct UDatasmithScene Scene; // 0x220 (8)
	struct TMap<struct FName, struct TSoftObjectPtr<UActor>> RelatedActors; // 0x228 (80)
};
...
public:
	...
	enum class EComponentMobility Mobility; // 0x60 (1)
...
public:
	...
	enum class ESkyLightSourceType SourceType; // 0x30 (1)
...
struct FDatasmithPostProcessSettingsTemplate {
	...
	char bOverride_VignetteIntensity : 1; // 0x0 (1)
	char bOverride_FilmWhitePoint : 1; // 0x0 (1)
	char bOverride_AutoExposureMethod : 1; // 0x0 (1)
	char bOverride_CameraISO : 1; // 0x0 (1)
	char bOverride_CameraShutterSpeed : 1; // 0x0 (1)
	char pad_0_7 : 1; // 0x0 (1)
	char bOverride_DepthOfFieldFstop : 1; // 0x4 (1)
	...
	enum class EAutoExposureMethod AutoExposureMethod; // 0x30 (1)
...
struct FDatasmithImportBaseOptions {
	...
	bool bIncludeGeometry; // 0x1 (1)
	bool bIncludeMaterial; // 0x2 (1)
	bool bIncludeLight; // 0x3 (1)
	bool bIncludeCamera; // 0x4 (1)
	bool bIncludeAnimation; // 0x5 (1)
...
struct FDatasmithStaticMeshImportOptions {
	...
	bool bGenerateLightmapUVs; // 0x2 (1)
	bool bRemoveDegenerates; // 0x3 (1)
};
...
struct FDatasmithReimportOptions {
	bool bUpdateActors; // 0x0 (1)
	bool bRespawnDeletedActors; // 0x1 (1)
};

// ScriptStruct DatasmithContent.DatasmithStaticParameterSetTemplate
struct FDatasmithStaticParameterSetTemplate {
	struct TMap<struct FName, bool> StaticSwitchParameters; // 0x0 (80)
};
...
struct FDatasmithMeshBuildSettingsTemplate {
	...
	char bGenerateLightmapUVs : 1; // 0x0 (1)

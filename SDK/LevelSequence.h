...
public:
	...
	void RemoveMetaDataByClass(struct UClass* InClass); // Function LevelSequence.LevelSequence.RemoveMetaDataByClass(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2B71DF0>
	struct Object FindOrAddMetaDataByClass(struct UClass* InClass); // Function LevelSequence.LevelSequence.FindOrAddMetaDataByClass(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2B71750>
	struct Object FindMetaDataByClass(struct UClass* InClass); // Function LevelSequence.LevelSequence.FindMetaDataByClass(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x2B71750>
	struct Object CopyMetaData(struct Object InMetaData); // Function LevelSequence.LevelSequence.CopyMetaData(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2B71750>
};
...
public:
	...
	bool bUseBurnIn; // 0x28 (1)
	struct FSoftClassPath BurnInClass; // 0x30 (24)
	struct ULevelSequenceBurnInInitSettings Settings; // 0x48 (8)

	void SetBurnIn(struct FSoftClassPath InBurnInClass); // Function LevelSequence.LevelSequenceBurnInOptions.SetBurnIn(Final|Native|Public|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2B721B0>
};
...
public:
	...
	struct FMovieSceneSequencePlaybackSettings PlaybackSettings; // 0x230 (20)
	struct ULevelSequencePlayer SequencePlayer; // 0x248 (8)
	struct FSoftObjectPath LevelSequence; // 0x250 (24)
	struct TArray<struct UActor> AdditionalEventReceivers; // 0x268 (16)
	struct FLevelSequenceCameraSettings CameraSettings; // 0x278 (2)
	struct ULevelSequenceBurnInOptions BurnInOptions; // 0x280 (8)
	struct UMovieSceneBindingOverrides BindingOverrides; // 0x288 (8)
	char bAutoPlay : 1; // 0x290 (1)
	char pad_276_1 : 7; // 0x276 (1)
	char pad_277_0 : 1; // 0x277 (1)
	char bOverrideInstanceData : 1; // 0x290 (1)
	char pad_277_2 : 6; // 0x277 (1)
	char pad_278_0 : 2; // 0x278 (1)
	char bReplicatePlayback : 1; // 0x290 (1)
	char pad_278_3 : 5; // 0x278 (1)
	struct Object DefaultInstanceData; // 0x298 (8)
	struct ULevelSequenceBurnIn BurnInInstance; // 0x2A0 (8)
	bool bShowBurnin; // 0x2A8 (1)

	void ShowBurnin(); // Function LevelSequence.LevelSequenceActor.ShowBurnin(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2B724C0>
	void SetSequence(struct ULevelSequence InSequence); // Function LevelSequence.LevelSequenceActor.SetSequence(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2B72440>
	void SetReplicatePlayback(bool ReplicatePlayback); // Function LevelSequence.LevelSequenceActor.SetReplicatePlayback(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2B723B0>
	void SetEventReceivers(struct TArray<struct UActor> AdditionalReceivers); // Function LevelSequence.LevelSequenceActor.SetEventReceivers(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2B72270>
	void SetBindingByTag(struct FName BindingTag, struct TArray<struct UActor>& Actors, bool bAllowBindingsFromAsset); // Function LevelSequence.LevelSequenceActor.SetBindingByTag(Final|Native|Public|HasOutParms|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2B72080>
	void SetBinding(struct FMovieSceneObjectBindingID Binding, struct TArray<struct UActor>& Actors, bool bAllowBindingsFromAsset); // Function LevelSequence.LevelSequenceActor.SetBinding(Final|Native|Public|HasOutParms|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2B71F30>
	void ResetBindings(); // Function LevelSequence.LevelSequenceActor.ResetBindings(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2B71F10>
	void ResetBinding(struct FMovieSceneObjectBindingID Binding); // Function LevelSequence.LevelSequenceActor.ResetBinding(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2B71E60>
	void RemoveBindingByTag(struct FName Tag, struct UActor Actor); // Function LevelSequence.LevelSequenceActor.RemoveBindingByTag(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2B71D30>
	void RemoveBinding(struct FMovieSceneObjectBindingID Binding, struct UActor Actor); // Function LevelSequence.LevelSequenceActor.RemoveBinding(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2B71C40>
	void OnLevelSequenceLoaded__DelegateSignature(); // DelegateFunction LevelSequence.LevelSequenceActor.OnLevelSequenceLoaded__DelegateSignature(Public|Delegate) // <VeiledExperts-Win64-Shipping.exe+0x1B72D40>
	struct ULevelSequence LoadSequence(); // Function LevelSequence.LevelSequenceActor.LoadSequence(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x2B71BD0>
	void HideBurnin(); // Function LevelSequence.LevelSequenceActor.HideBurnin(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2B71BB0>
	struct ULevelSequencePlayer GetSequencePlayer(); // Function LevelSequence.LevelSequenceActor.GetSequencePlayer(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x2B71B60>
	struct ULevelSequence GetSequence(); // Function LevelSequence.LevelSequenceActor.GetSequence(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x2B71B10>
	struct TArray<struct FMovieSceneObjectBindingID> FindNamedBindings(struct FName Tag); // Function LevelSequence.LevelSequenceActor.FindNamedBindings(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x2B719F0>
	struct FMovieSceneObjectBindingID FindNamedBinding(struct FName Tag); // Function LevelSequence.LevelSequenceActor.FindNamedBinding(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x2B71940>
	void AddBindingByTag(struct FName BindingTag, struct UActor Actor, bool bAllowBindingsFromAsset); // Function LevelSequence.LevelSequenceActor.AddBindingByTag(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2B71640>
	void AddBinding(struct FMovieSceneObjectBindingID Binding, struct UActor Actor, bool bAllowBindingsFromAsset); // Function LevelSequence.LevelSequenceActor.AddBinding(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2B71500>
};
...
public:
	...
	struct FLevelSequencePlayerSnapshot FrameInformation; // 0x230 (184)
	struct ALevelSequenceActor LevelSequenceActor; // 0x2E8 (8)

	void SetSettings(struct Object InSettings); // Function LevelSequence.LevelSequenceBurnIn.SetSettings(Event|Public|BlueprintEvent) // <VeiledExperts-Win64-Shipping.exe+0x1B72D40>
	struct UClass* GetSettingsClass(); // Function LevelSequence.LevelSequenceBurnIn.GetSettingsClass(Native|Event|Public|BlueprintEvent|Const) // <VeiledExperts-Win64-Shipping.exe+0x2B71B90>
};
...
public:
	...
	void OnCreated(); // Function LevelSequence.LevelSequenceDirector.OnCreated(Event|Public|BlueprintEvent) // <VeiledExperts-Win64-Shipping.exe+0x1B72D40>
};
...
public:
	...
	struct FMulticastInlineDelegate OnCameraCut; // 0x888 (16)

	struct UCameraComponent GetActiveCameraComponent(); // Function LevelSequence.LevelSequencePlayer.GetActiveCameraComponent(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x2B71AD0>
	struct ULevelSequencePlayer CreateLevelSequencePlayer(struct Object WorldContextObject, struct ULevelSequence LevelSequence, struct FMovieSceneSequencePlaybackSettings Settings, struct ALevelSequenceActor& OutActor); // Function LevelSequence.LevelSequencePlayer.CreateLevelSequencePlayer(Final|Native|Static|Public|HasOutParms|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2B717D0>
};
...
public:
	...
	struct ALevelSequenceActor Sequence; // 0x228 (8)
	struct UMediaComponent MediaComponent; // 0x230 (8)
	float ServerStartTimeSeconds; // 0x238 (4)

	void SynchronizeToServer(float DesyncThresholdSeconds); // Function LevelSequence.LevelSequenceMediaController.SynchronizeToServer(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2B724E0>
	void Play(); // Function LevelSequence.LevelSequenceMediaController.Play(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2B71C20>
	void OnRep_ServerStartTimeSeconds(); // Function LevelSequence.LevelSequenceMediaController.OnRep_ServerStartTimeSeconds(Final|Native|Private) // <VeiledExperts-Win64-Shipping.exe+0x2B71C00>
	struct ALevelSequenceActor GetSequence(); // Function LevelSequence.LevelSequenceMediaController.GetSequence(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x2B71B40>
	struct UMediaComponent GetMediaComponent(); // Function LevelSequence.LevelSequenceMediaController.GetMediaComponent(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x2A22F00>
};

// ScriptStruct LevelSequence.LevelSequenceCameraSettings
struct FLevelSequenceCameraSettings {
	bool bOverrideAspectRatioAxisConstraint; // 0x0 (1)
	enum class EAspectRatioAxisConstraint AspectRatioAxisConstraint; // 0x1 (1)
};
...
inline void ALevelSequenceActor::SetReplicatePlayback(bool ReplicatePlayback) {
...
inline void ALevelSequenceActor::SetBindingByTag(struct FName BindingTag, struct TArray<struct UActor>& Actors, bool bAllowBindingsFromAsset) {
...
inline void ALevelSequenceActor::SetBinding(struct FMovieSceneObjectBindingID Binding, struct TArray<struct UActor>& Actors, bool bAllowBindingsFromAsset) {
...
inline void ALevelSequenceActor::AddBindingByTag(struct FName BindingTag, struct UActor Actor, bool bAllowBindingsFromAsset) {
...
inline void ALevelSequenceActor::AddBinding(struct FMovieSceneObjectBindingID Binding, struct UActor Actor, bool bAllowBindingsFromAsset) {

...
struct FARFilter {
	...
	bool bRecursivePaths; // 0xE0 (1)
	bool bRecursiveClasses; // 0xE1 (1)
	bool bIncludeOnlyOnDiskAssets; // 0xE2 (1)
};
...
struct FAssetRegistryDependencyOptions {
	bool bIncludeSoftPackageReferences; // 0x0 (1)
	bool bIncludeHardPackageReferences; // 0x1 (1)
	bool bIncludeSearchableNames; // 0x2 (1)
	bool bIncludeSoftManagementReferences; // 0x3 (1)
	bool bIncludeHardManagementReferences; // 0x4 (1)
};

...
public:
	...
	bool TryPurchaseItemAsync(struct FPurchaseItemDetails& ItemDetails); // Function MagicLeap.InAppPurchaseComponent.TryPurchaseItemAsync(Final|Native|Public|HasOutParms|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1198520>
	bool TryGetPurchaseHistoryAsync(int32_t InNumPages); // Function MagicLeap.InAppPurchaseComponent.TryGetPurchaseHistoryAsync(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1198490>
	bool TryGetItemsDetailsAsync(struct TArray<struct FString>& ItemIDs); // Function MagicLeap.InAppPurchaseComponent.TryGetItemsDetailsAsync(Final|Native|Public|HasOutParms|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x11983B0>
	void PurchaseConfirmationSuccess__DelegateSignature(struct FPurchaseConfirmation& PurchaseConfirmations); // DelegateFunction MagicLeap.InAppPurchaseComponent.PurchaseConfirmationSuccess__DelegateSignature(MulticastDelegate|Public|Delegate|HasOutParms) // <VeiledExperts-Win64-Shipping.exe+0x1B72D40>
	void PurchaseConfirmationFailure__DelegateSignature(); // DelegateFunction MagicLeap.InAppPurchaseComponent.PurchaseConfirmationFailure__DelegateSignature(MulticastDelegate|Public|Delegate) // <VeiledExperts-Win64-Shipping.exe+0x1B72D40>
	void InAppPurchaseLogMessage__DelegateSignature(struct FString LogMessage); // DelegateFunction MagicLeap.InAppPurchaseComponent.InAppPurchaseLogMessage__DelegateSignature(MulticastDelegate|Public|Delegate) // <VeiledExperts-Win64-Shipping.exe+0x1B72D40>
	void GetPurchaseHistorySuccess__DelegateSignature(struct TArray<struct FPurchaseConfirmation>& PurchaseHistory); // DelegateFunction MagicLeap.InAppPurchaseComponent.GetPurchaseHistorySuccess__DelegateSignature(MulticastDelegate|Public|Delegate|HasOutParms) // <VeiledExperts-Win64-Shipping.exe+0x1B72D40>
	void GetPurchaseHistoryFailure__DelegateSignature(); // DelegateFunction MagicLeap.InAppPurchaseComponent.GetPurchaseHistoryFailure__DelegateSignature(MulticastDelegate|Public|Delegate) // <VeiledExperts-Win64-Shipping.exe+0x1B72D40>
	void GetItemsDetailsSuccess__DelegateSignature(struct TArray<struct FPurchaseItemDetails>& ItemsDetails); // DelegateFunction MagicLeap.InAppPurchaseComponent.GetItemsDetailsSuccess__DelegateSignature(MulticastDelegate|Public|Delegate|HasOutParms) // <VeiledExperts-Win64-Shipping.exe+0x1B72D40>
	void GetItemsDetailsFailure__DelegateSignature(); // DelegateFunction MagicLeap.InAppPurchaseComponent.GetItemsDetailsFailure__DelegateSignature(MulticastDelegate|Public|Delegate) // <VeiledExperts-Win64-Shipping.exe+0x1B72D40>
};
...
public:
	...
	struct FMulticastInlineDelegate OnMeshTrackerUpdated; // 0x1F8 (16)
	bool ScanWorld; // 0x208 (1)
	enum class EMagicLeapMeshType MeshType; // 0x209 (1)
	struct UBoxComponent BoundingVolume; // 0x210 (8)
	enum class EMagicLeapMeshLOD LevelOfDetail; // 0x218 (1)
	float PerimeterOfGapsToFill; // 0x21C (4)
	bool Planarize; // 0x220 (1)
	float DisconnectedSectionArea; // 0x224 (4)
	bool RequestNormals; // 0x228 (1)
	bool RequestVertexConfidence; // 0x229 (1)
	enum class EMagicLeapMeshVertexColorMode VertexColorMode; // 0x22A (1)
	struct TArray<struct FColor> BlockVertexColors; // 0x230 (16)
	struct FLinearColor VertexColorFromConfidenceZero; // 0x240 (16)
	struct FLinearColor VertexColorFromConfidenceOne; // 0x250 (16)
	bool RemoveOverlappingTriangles; // 0x260 (1)
	struct UMRMeshComponent MRMesh; // 0x268 (8)
	int32_t BricksPerFrame; // 0x270 (4)

	void SelectMeshBlocks(struct FMagicLeapTrackingMeshInfo& NewMeshInfo, struct TArray<struct FMagicLeapMeshBlockRequest>& RequestedMesh); // Function MagicLeap.MagicLeapMeshTrackerComponent.SelectMeshBlocks(Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <VeiledExperts-Win64-Shipping.exe+0x1198060>
	void OnMeshTrackerUpdated__DelegateSignature(struct FGuid ID, struct TArray<struct FVector>& Vertices, struct TArray<int32_t>& Triangles, struct TArray<struct FVector>& Normals, struct TArray<float>& Confidence); // DelegateFunction MagicLeap.MagicLeapMeshTrackerComponent.OnMeshTrackerUpdated__DelegateSignature(MulticastDelegate|Public|Delegate|HasOutParms|HasDefaults) // <VeiledExperts-Win64-Shipping.exe+0x1B72D40>
	int32_t GetNumQueuedBlockUpdates(); // Function MagicLeap.MagicLeapMeshTrackerComponent.GetNumQueuedBlockUpdates(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1197B10>
	void DisconnectMRMesh(struct UMRMeshComponent InMRMeshPtr); // Function MagicLeap.MagicLeapMeshTrackerComponent.DisconnectMRMesh(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1197740>
	void DisconnectBlockSelector(); // Function MagicLeap.MagicLeapMeshTrackerComponent.DisconnectBlockSelector(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1197720>
	void ConnectMRMesh(struct UMRMeshComponent InMRMeshPtr); // Function MagicLeap.MagicLeapMeshTrackerComponent.ConnectMRMesh(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x11976A0>
	void ConnectBlockSelector(struct TScriptInterface<IMagicLeapMeshBlockSelectorInterface> Selector); // Function MagicLeap.MagicLeapMeshTrackerComponent.ConnectBlockSelector(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1197600>
};
...
public:
	...
	bool bEnableZI; // 0x28 (1)
	bool bUseVulkanForZI; // 0x29 (1)
	bool bUseMLAudioForZI; // 0x2A (1)
};
...
struct FMagicLeapRaycastQueryParams {
	...
	bool CollideWithUnobserved; // 0x30 (1)
...
inline bool UInAppPurchaseComponent::TryPurchaseItemAsync(struct FPurchaseItemDetails& ItemDetails) {
...
inline bool UInAppPurchaseComponent::TryGetPurchaseHistoryAsync(int32_t InNumPages) {
...
inline bool UInAppPurchaseComponent::TryGetItemsDetailsAsync(struct TArray<struct FString>& ItemIDs) {

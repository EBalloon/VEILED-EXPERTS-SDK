...
public:
	...
	void OnNotifyEndReceived(struct FName NotifyName, struct FBranchingPointNotifyPayload& BranchingPointNotifyPayload); // Function AnimGraphRuntime.PlayMontageCallbackProxy.OnNotifyEndReceived(Final|Native|Protected|HasOutParms) // <VeiledExperts-Win64-Shipping.exe+0x28E5370>
	void OnNotifyBeginReceived(struct FName NotifyName, struct FBranchingPointNotifyPayload& BranchingPointNotifyPayload); // Function AnimGraphRuntime.PlayMontageCallbackProxy.OnNotifyBeginReceived(Final|Native|Protected|HasOutParms) // <VeiledExperts-Win64-Shipping.exe+0x28E5290>
	void OnMontageEnded(struct UAnimMontage Montage, bool bInterrupted); // Function AnimGraphRuntime.PlayMontageCallbackProxy.OnMontageEnded(Final|Native|Protected) // <VeiledExperts-Win64-Shipping.exe+0x28E51C0>
	void OnMontageBlendingOut(struct UAnimMontage Montage, bool bInterrupted); // Function AnimGraphRuntime.PlayMontageCallbackProxy.OnMontageBlendingOut(Final|Native|Protected) // <VeiledExperts-Win64-Shipping.exe+0x28E50F0>
	struct UPlayMontageCallbackProxy CreateProxyObjectForPlayMontage(struct USkeletalMeshComponent InSkeletalMeshComponent, struct UAnimMontage MontageToPlay, float PlayRate, float StartingPosition, struct FName StartingSection); // Function AnimGraphRuntime.PlayMontageCallbackProxy.CreateProxyObjectForPlayMontage(Final|Native|Static|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x28E3B10>
};
...
struct FAnimNode_BlendSpacePlayer : FAnimNode_AssetPlayerBase {
	...
	bool bLoop; // 0x40 (1)
	bool bResetPlayTimeWhenBlendSpaceChanges; // 0x41 (1)
...
struct FAnimNode_AnimDynamics : FAnimNode_SkeletalControlBase {
	...
	char bUseSphericalLimits : 1; // 0x244 (1)
	char pad_1DE_1 : 7; // 0x1DE (1)
	char pad_1DF_0 : 1; // 0x1DF (1)
	char bUsePlanarLimit : 1; // 0x244 (1)
	char pad_1DF_2 : 6; // 0x1DF (1)
	char pad_1E0_0 : 2; // 0x1E0 (1)
	char bDoUpdate : 1; // 0x244 (1)
	char pad_1E0_3 : 5; // 0x1E0 (1)
	char pad_1E1_0 : 3; // 0x1E1 (1)
	char bDoEval : 1; // 0x244 (1)
	char pad_1E1_4 : 4; // 0x1E1 (1)
	char pad_1E2_0 : 4; // 0x1E2 (1)
	char bOverrideLinearDamping : 1; // 0x244 (1)
	char pad_1E2_5 : 3; // 0x1E2 (1)
	char pad_1E3_0 : 5; // 0x1E3 (1)
	char bOverrideAngularBias : 1; // 0x244 (1)
	char pad_1E3_6 : 2; // 0x1E3 (1)
	char pad_1E4_0 : 6; // 0x1E4 (1)
	char bOverrideAngularDamping : 1; // 0x244 (1)
	char pad_1E4_7 : 1; // 0x1E4 (1)
	char pad_1E5_0 : 7; // 0x1E5 (1)
	char bEnableWind : 1; // 0x244 (1)
	char pad_1E6_0 : 1; // 0x1E6 (1)
	char bUseGravityOverride : 1; // 0x245 (1)
	char pad_1E6_2 : 6; // 0x1E6 (1)
	char pad_1E7_0 : 2; // 0x1E7 (1)
	char bLinearSpring : 1; // 0x245 (1)
	char pad_1E7_3 : 5; // 0x1E7 (1)
	char pad_1E8_0 : 3; // 0x1E8 (1)
	char bAngularSpring : 1; // 0x245 (1)
	char pad_1E8_4 : 4; // 0x1E8 (1)
	char pad_1E9_0 : 4; // 0x1E9 (1)
	char bChain : 1; // 0x245 (1)
	char pad_1E9_5 : 3; // 0x1E9 (1)
...
struct FAnimNode_BlendBoneByChannel : FAnimNode_Base {
	...
	enum class EBoneControlSpace TransformsSpace; // 0x60 (1)
};
...
struct FBlendBoneByChannelEntry {
	...
	bool bBlendTranslation; // 0x20 (1)
	bool bBlendRotation; // 0x21 (1)
	bool bBlendScale; // 0x22 (1)
};
...
struct FAnimNode_BlendListBase : FAnimNode_Base {
	...
	bool bResetChildOnActivation; // 0x32 (1)
...
struct FAnimNode_BoneDrivenController : FAnimNode_SkeletalControlBase {
	...
	enum class EComponentType SourceComponent; // 0x10E (1)
	char bUseRange : 1; // 0x10F (1)
	char bAffectTargetTranslationX : 1; // 0x10F (1)
	char bAffectTargetTranslationY : 1; // 0x10F (1)
	char bAffectTargetTranslationZ : 1; // 0x10F (1)
	char bAffectTargetRotationX : 1; // 0x10F (1)
	char bAffectTargetRotationY : 1; // 0x10F (1)
	char bAffectTargetRotationZ : 1; // 0x10F (1)
	char bAffectTargetScaleX : 1; // 0x10F (1)
	char bAffectTargetScaleY : 1; // 0x110 (1)
	char bAffectTargetScaleZ : 1; // 0x110 (1)
};

// ScriptStruct AnimGraphRuntime.AnimNode_CCDIK
struct FAnimNode_CCDIK : FAnimNode_SkeletalControlBase {
	struct FVector EffectorLocation; // 0xC8 (12)
	enum class EBoneControlSpace EffectorLocationSpace; // 0xD4 (1)
...
struct FAnimNode_CopyBone : FAnimNode_SkeletalControlBase {
	...
	bool bCopyTranslation; // 0xE8 (1)
	bool bCopyRotation; // 0xE9 (1)
	bool bCopyScale; // 0xEA (1)
	enum class EBoneControlSpace ControlSpace; // 0xEB (1)
};
...
struct FAnimNode_CopyPoseFromMesh : FAnimNode_Base {
	...
	bool bUseAttachedParent; // 0x18 (1)
	bool bCopyCurves; // 0x19 (1)
};
...
struct FAnimNode_Fabrik : FAnimNode_SkeletalControlBase {
	...
	enum class EBoneControlSpace EffectorTransformSpace; // 0x188 (1)
	enum class EBoneRotationSource EffectorRotationSource; // 0x189 (1)
};
...
struct FAnimNode_LayeredBoneBlend : FAnimNode_Base {
	...
	bool bMeshSpaceRotationBlend; // 0x50 (1)
	bool bMeshSpaceScaleBlend; // 0x51 (1)
	enum class ECurveBlendOption CurveBlendOption; // 0x52 (1)
	bool bBlendRootMotionBasedOnRootBone; // 0x53 (1)
...
struct FAnimLegIKDefinition {
	...
	enum class EAxis FootBoneForwardAxis; // 0x28 (1)
	enum class EAxis HingeRotationAxis; // 0x29 (1)
	bool bEnableRotationLimit; // 0x2A (1)
	bool bEnableKneeTwistCorrection; // 0x2B (1)
};
...
struct FAnimNode_LookAt : FAnimNode_SkeletalControlBase {
	...
	bool bUseLookUpAxis; // 0x15C (1)
	enum class EInterpolationBlend InterpolationType; // 0x15D (1)
...
struct FAnimNode_MakeDynamicAdditive : FAnimNode_Base {
	struct FPoseLink Base; // 0x10 (16)
	struct FPoseLink Additive; // 0x20 (16)
	bool bMeshSpaceAdditive; // 0x30 (1)
};
...
struct FAnimNode_ModifyBone : FAnimNode_SkeletalControlBase {
	...
	enum class EBoneModificationMode TranslationMode; // 0xFC (1)
	enum class EBoneModificationMode RotationMode; // 0xFD (1)
	enum class EBoneModificationMode ScaleMode; // 0xFE (1)
	enum class EBoneControlSpace TranslationSpace; // 0xFF (1)
	enum class EBoneControlSpace RotationSpace; // 0x100 (1)
	enum class EBoneControlSpace ScaleSpace; // 0x101 (1)
};
...
struct FAnimNode_MultiWayBlend : FAnimNode_Base {
	...
	bool bAdditiveNode; // 0x48 (1)
	bool bNormalizeAlpha; // 0x49 (1)
};

// ScriptStruct AnimGraphRuntime.AnimNode_ObserveBone
struct FAnimNode_ObserveBone : FAnimNode_SkeletalControlBase {
	struct FBoneReference BoneToObserve; // 0xC8 (16)
	enum class EBoneControlSpace DisplaySpace; // 0xD8 (1)
	bool bRelativeToRefPose; // 0xD9 (1)
...
struct FAnimNode_PoseDriver : FAnimNode_PoseHandler {
	...
	char bOnlyDriveSelectedBones : 1; // 0x126 (1)
};
...
struct FRBFParams {
	...
	enum class EBoneAxis TwistAxis; // 0xE (1)
...
struct FAnimNode_RefPose : FAnimNode_Base {
	enum class ERefPoseType RefPoseType; // 0x10 (1)
};
...
struct FAnimNode_RigidBody : FAnimNode_SkeletalControlBase {
	...
	enum class ECollisionChannel OverlapChannel; // 0x1B8 (1)
	enum class ESimulationSpace SimulationSpace; // 0x1B9 (1)
	bool bForceDisableCollisionBetweenConstraintBodies; // 0x1BA (1)
	char bEnableWorldGeometry : 1; // 0x1BC (1)
	char pad_123_1 : 7; // 0x123 (1)
	char pad_124_0 : 1; // 0x124 (1)
	char bOverrideWorldGravity : 1; // 0x1BC (1)
	char pad_124_2 : 6; // 0x124 (1)
	char pad_125_0 : 2; // 0x125 (1)
	char bTransferBoneVelocities : 1; // 0x1BC (1)
	char pad_125_3 : 5; // 0x125 (1)
	char pad_126_0 : 3; // 0x126 (1)
	char bFreezeIncomingPoseOnStart : 1; // 0x1BC (1)
	char pad_126_4 : 4; // 0x126 (1)
	char pad_127_0 : 4; // 0x127 (1)
	char bClampLinearTranslationLimitToRefPose : 1; // 0x1BC (1)
	char pad_127_5 : 3; // 0x127 (1)
...
struct FAnimNode_RigidBody_Chaos : FAnimNode_SkeletalControlBase {
	...
	enum class ECollisionChannel OverlapChannel; // 0x120 (1)
	enum class ESimulationSpace SimulationSpace; // 0x121 (1)
	bool bForceDisableCollisionBetweenConstraintBodies; // 0x122 (1)
	char bEnableWorldGeometry : 1; // 0x123 (1)
	char bOverrideWorldGravity : 1; // 0x123 (1)
	char bTransferBoneVelocities : 1; // 0x123 (1)
	char bFreezeIncomingPoseOnStart : 1; // 0x123 (1)
	char bClampLinearTranslationLimitToRefPose : 1; // 0x123 (1)
...
struct FAnimNode_RotationMultiplier : FAnimNode_SkeletalControlBase {
	...
	enum class EBoneAxis RotationAxisToRefer; // 0xEC (1)
	bool bIsAdditive; // 0xED (1)
};
...
struct FAnimNode_RotationOffsetBlendSpace : FAnimNode_BlendSpacePlayer {
	...
	bool bAlphaBoolEnabled; // 0x185 (1)
};
...
struct FAnimNode_SequenceEvaluator : FAnimNode_AssetPlayerBase {
	...
	bool bShouldLoop; // 0x3C (1)
	bool bTeleportToExplicitTime; // 0x3D (1)
	enum class ESequenceEvalReinit ReinitializationBehavior; // 0x3E (1)
...
struct FAnimNode_Slot : FAnimNode_Base {
	...
	bool bAlwaysUpdateSourcePose; // 0x28 (1)
};
...
struct FAnimNode_SplineIK : FAnimNode_SkeletalControlBase {
	...
	bool bAutoCalculateSpline; // 0xE9 (1)
...
struct FAnimNode_SpringBone : FAnimNode_SkeletalControlBase {
	...
	char bLimitDisplacement : 1; // 0x124 (1)
	char pad_E8_1 : 7; // 0xE8 (1)
	char pad_E9_0 : 1; // 0xE9 (1)
	char bTranslateX : 1; // 0x124 (1)
	char pad_E9_2 : 6; // 0xE9 (1)
	char pad_EA_0 : 2; // 0xEA (1)
	char bTranslateY : 1; // 0x124 (1)
	char pad_EA_3 : 5; // 0xEA (1)
	char pad_EB_0 : 3; // 0xEB (1)
	char bTranslateZ : 1; // 0x124 (1)
	char pad_EB_4 : 4; // 0xEB (1)
	char pad_EC_0 : 4; // 0xEC (1)
	char bRotateX : 1; // 0x124 (1)
	char pad_EC_5 : 3; // 0xEC (1)
	char pad_ED_0 : 5; // 0xED (1)
	char bRotateY : 1; // 0x124 (1)
	char pad_ED_6 : 2; // 0xED (1)
	char pad_EE_0 : 6; // 0xEE (1)
	char bRotateZ : 1; // 0x124 (1)
};
...
struct FAnimNode_Trail : FAnimNode_SkeletalControlBase {
	...
	enum class EAxis ChainBoneAxis; // 0x114 (1)
	char bInvertChainBoneAxis : 1; // 0x115 (1)
	char pad_DD_1 : 7; // 0xDD (1)
	char pad_DE_0 : 1; // 0xDE (1)
	char bLimitStretch : 1; // 0x115 (1)
	char pad_DE_2 : 6; // 0xDE (1)
	char pad_DF_0 : 2; // 0xDF (1)
	char bLimitRotation : 1; // 0x115 (1)
	char pad_DF_3 : 5; // 0xDF (1)
	char pad_E0_0 : 3; // 0xE0 (1)
	char bUsePlanarLimit : 1; // 0x115 (1)
	char pad_E0_4 : 4; // 0xE0 (1)
	char pad_E1_0 : 4; // 0xE1 (1)
	char bActorSpaceFakeVel : 1; // 0x115 (1)
	char pad_E1_5 : 3; // 0xE1 (1)
	char pad_E2_0 : 5; // 0xE2 (1)
	char bReorientParentToChild : 1; // 0x115 (1)
	char pad_E2_6 : 2; // 0xE2 (1)
...
struct FAnimNode_TwoBoneIK : FAnimNode_SkeletalControlBase {
	...
	enum class EBoneControlSpace EffectorLocationSpace; // 0x1D0 (1)
	enum class EBoneControlSpace JointTargetLocationSpace; // 0x1D1 (1)
	char bAllowStretching : 1; // 0x1D2 (1)
	char pad_1CA_1 : 7; // 0x1CA (1)
	char pad_1CB_0 : 1; // 0x1CB (1)
	char bTakeRotationFromEffectorSpace : 1; // 0x1D2 (1)
	char pad_1CB_2 : 6; // 0x1CB (1)
	char pad_1CC_0 : 2; // 0x1CC (1)
	char bMaintainEffectorRelRot : 1; // 0x1D2 (1)
	char pad_1CC_3 : 5; // 0x1CC (1)
	char pad_1CD_0 : 3; // 0x1CD (1)
	char bAllowTwist : 1; // 0x1D2 (1)
};
...
struct FAnimNode_TwoWayBlend : FAnimNode_Base {
	...
	char bAlphaBoolEnabled : 1; // 0x31 (1)
	char pad_31_1 : 2; // 0x31 (1)
	char bResetChildOnActivation : 1; // 0x31 (1)
	char pad_31_4 : 4; // 0x31 (1)
	float Alpha; // 0x34 (4)
...
inline void UPlayMontageCallbackProxy::OnMontageEnded(struct UAnimMontage Montage, bool bInterrupted) {
...
inline void UPlayMontageCallbackProxy::OnMontageBlendingOut(struct UAnimMontage Montage, bool bInterrupted) {

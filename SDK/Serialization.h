...
struct FStructSerializerBooleanTestStruct {
	bool BoolFalse; // 0x0 (1)
	bool BoolTrue; // 0x1 (1)
	char Bitfield0 : 1; // 0x2 (1)
	char Bitfield1 : 1; // 0x2 (1)
	char Bitfield2Set : 1; // 0x2 (1)
	char Bitfield3 : 1; // 0x2 (1)
	char Bitfield4Set : 1; // 0x2 (1)
	char Bitfield5Set : 1; // 0x2 (1)
	char Bitfield6 : 1; // 0x2 (1)
	char Bitfield7Set : 1; // 0x2 (1)
};

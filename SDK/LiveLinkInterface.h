...
struct FLiveLinkCameraStaticData : FLiveLinkTransformStaticData {
	bool bIsFieldOfViewSupported; // 0x10 (1)
	bool bIsAspectRatioSupported; // 0x11 (1)
	bool bIsFocalLengthSupported; // 0x12 (1)
	bool bIsProjectionModeSupported; // 0x13 (1)
	float FilmBackWidth; // 0x14 (4)
	float FilmBackHeight; // 0x18 (4)
	bool bIsApertureSupported; // 0x1C (1)
	bool bIsFocusDistanceSupported; // 0x1D (1)
};
...
struct FLiveLinkLightStaticData : FLiveLinkTransformStaticData {
	bool bIsTemperatureSupported; // 0x10 (1)
	bool bIsIntensitySupported; // 0x11 (1)
	bool bIsLightColorSupported; // 0x12 (1)
	bool bIsInnerConeAngleSupported; // 0x13 (1)
	bool bIsOuterConeAngleSupported; // 0x14 (1)
	bool bIsAttenuationRadiusSupported; // 0x15 (1)
	bool bIsSourceLenghtSupported; // 0x16 (1)
	bool bIsSourceRadiusSupported; // 0x17 (1)
	bool bIsSoftSourceRadiusSupported; // 0x18 (1)
};
...
struct FLiveLinkSourceBufferManagementSettings {
	bool bValidEngineTimeEnabled; // 0x0 (1)
	...
	bool bGenerateSubFrame; // 0x20 (1)
	bool bUseTimecodeSmoothLatest; // 0x21 (1)
	struct FFrameRate SourceTimecodeFrameRate; // 0x24 (8)
	bool bValidTimecodeFrameEnabled; // 0x2C (1)
	...
	bool bKeepAtLeastOneFrame; // 0x48 (1)
};

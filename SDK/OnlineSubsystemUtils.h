...
public:
	...
	float SocketErrorDisconnectDelay; // 0x1A80 (4)
};
...
public:
	...
	char LogPortUnreach : 1; // 0x748 (1)
	char AllowPlayerPortUnreach : 1; // 0x748 (1)
	char pad_748_2 : 6; // 0x748 (1)
...
public:
	...
	struct UAchievementQueryCallbackProxy CacheAchievements(struct Object WorldContextObject, struct APlayerController PlayerController); // Function OnlineSubsystemUtils.AchievementQueryCallbackProxy.CacheAchievements(Final|Native|Static|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xDCB830>
	struct UAchievementQueryCallbackProxy CacheAchievementDescriptions(struct Object WorldContextObject, struct APlayerController PlayerController); // Function OnlineSubsystemUtils.AchievementQueryCallbackProxy.CacheAchievementDescriptions(Final|Native|Static|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xDCB770>
};
...
public:
	...
	struct UConnectionCallbackProxy ConnectToService(struct Object WorldContextObject, struct APlayerController PlayerController); // Function OnlineSubsystemUtils.ConnectionCallbackProxy.ConnectToService(Final|Native|Static|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xDCB8F0>
};
...
public:
	...
	struct UCreateSessionCallbackProxy CreateSession(struct Object WorldContextObject, struct APlayerController PlayerController, int32_t PublicConnections, bool bUseLAN); // Function OnlineSubsystemUtils.CreateSessionCallbackProxy.CreateSession(Final|Native|Static|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xDCC0F0>
};
...
public:
	...
	struct UDestroySessionCallbackProxy DestroySession(struct Object WorldContextObject, struct APlayerController PlayerController); // Function OnlineSubsystemUtils.DestroySessionCallbackProxy.DestroySession(Final|Native|Static|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xDCC220>
};
...
public:
	...
	struct UEndMatchCallbackProxy EndMatch(struct Object WorldContextObject, struct APlayerController PlayerController, struct TScriptInterface<ITurnBasedMatchInterface> MatchActor, struct FString MatchID, enum class EMPMatchOutcome LocalPlayerOutcome, enum class EMPMatchOutcome OtherPlayersOutcome); // Function OnlineSubsystemUtils.EndMatchCallbackProxy.EndMatch(Final|Native|Static|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xDCC2E0>
};
...
public:
	...
	struct FString GetServerName(struct FBlueprintSessionResult& Result); // Function OnlineSubsystemUtils.FindSessionsCallbackProxy.GetServerName(Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure) // <VeiledExperts-Win64-Shipping.exe+0xDCD260>
	int32_t GetPingInMs(struct FBlueprintSessionResult& Result); // Function OnlineSubsystemUtils.FindSessionsCallbackProxy.GetPingInMs(Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure) // <VeiledExperts-Win64-Shipping.exe+0xDCD130>
	int32_t GetMaxPlayers(struct FBlueprintSessionResult& Result); // Function OnlineSubsystemUtils.FindSessionsCallbackProxy.GetMaxPlayers(Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure) // <VeiledExperts-Win64-Shipping.exe+0xDCD000>
	int32_t GetCurrentPlayers(struct FBlueprintSessionResult& Result); // Function OnlineSubsystemUtils.FindSessionsCallbackProxy.GetCurrentPlayers(Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure) // <VeiledExperts-Win64-Shipping.exe+0xDCCED0>
	struct UFindSessionsCallbackProxy FindSessions(struct Object WorldContextObject, struct APlayerController PlayerController, int32_t MaxResults, bool bUseLAN); // Function OnlineSubsystemUtils.FindSessionsCallbackProxy.FindSessions(Final|Native|Static|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xDCC6A0>
};
...
public:
	...
	struct UFindTurnBasedMatchCallbackProxy FindTurnBasedMatch(struct Object WorldContextObject, struct APlayerController PlayerController, struct TScriptInterface<ITurnBasedMatchInterface> MatchActor, int32_t MinPlayers, int32_t MaxPlayers, int32_t PlayerGroup, bool ShowExistingMatches); // Function OnlineSubsystemUtils.FindTurnBasedMatchCallbackProxy.FindTurnBasedMatch(Final|Native|Static|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xDCC7D0>
};
...
public:
	...
	struct UInAppPurchaseCallbackProxy CreateProxyObjectForInAppPurchase(struct APlayerController PlayerController, struct FInAppPurchaseProductRequest& ProductRequest); // Function OnlineSubsystemUtils.InAppPurchaseCallbackProxy.CreateProxyObjectForInAppPurchase(Final|Native|Static|Public|HasOutParms|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xDCBAA0>
};
...
public:
	...
	struct UInAppPurchaseQueryCallbackProxy CreateProxyObjectForInAppPurchaseQuery(struct APlayerController PlayerController, struct TArray<struct FString>& ProductIdentifiers); // Function OnlineSubsystemUtils.InAppPurchaseQueryCallbackProxy.CreateProxyObjectForInAppPurchaseQuery(Final|Native|Static|Public|HasOutParms|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xDCBCA0>
};
...
public:
	...
	struct UInAppPurchaseQueryCallbackProxy2 CreateProxyObjectForInAppPurchaseQuery(struct APlayerController PlayerController, struct TArray<struct FString>& ProductIdentifiers); // Function OnlineSubsystemUtils.InAppPurchaseQueryCallbackProxy2.CreateProxyObjectForInAppPurchaseQuery(Final|Native|Static|Public|HasOutParms|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xDCBB90>
};
...
public:
	...
	struct UInAppPurchaseRestoreCallbackProxy CreateProxyObjectForInAppPurchaseRestore(struct TArray<struct FInAppPurchaseProductRequest>& ConsumableProductFlags, struct APlayerController PlayerController); // Function OnlineSubsystemUtils.InAppPurchaseRestoreCallbackProxy.CreateProxyObjectForInAppPurchaseRestore(Final|Native|Static|Public|HasOutParms|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xDCBF50>
};
...
public:
	...
	struct UInAppPurchaseRestoreCallbackProxy2 CreateProxyObjectForInAppPurchaseRestore(struct TArray<struct FInAppPurchaseProductRequest2>& ConsumableProductFlags, struct APlayerController PlayerController); // Function OnlineSubsystemUtils.InAppPurchaseRestoreCallbackProxy2.CreateProxyObjectForInAppPurchaseRestore(Final|Native|Static|Public|HasOutParms|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xDCBE30>
};
...
public:
	...
	struct ULeaderboardFlushCallbackProxy CreateProxyObjectForFlush(struct APlayerController PlayerController, struct FName SessionName); // Function OnlineSubsystemUtils.LeaderboardFlushCallbackProxy.CreateProxyObjectForFlush(Final|Native|Static|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xDD0F50>
};
...
public:
	...
	struct ULogoutCallbackProxy Logout(struct Object WorldContextObject, struct APlayerController PlayerController); // Function OnlineSubsystemUtils.LogoutCallbackProxy.Logout(Final|Native|Static|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xDD1220>
};
...
public:
	...
	float BeaconConnectionInitialTimeout; // 0x228 (4)
	float BeaconConnectionTimeout; // 0x22C (4)
	struct UNetDriver NetDriver; // 0x230 (8)
};
...
public:
	...
	struct AOnlineBeaconHostObject BeaconOwner; // 0x250 (8)
	struct UNetConnection BeaconConnection; // 0x258 (8)
	enum class EBeaconConnectionState ConnectionState; // 0x260 (1)

	void ClientOnConnected(); // Function OnlineSubsystemUtils.OnlineBeaconClient.ClientOnConnected(Final|Net|NetReliableNative|Event|Private|NetClient) // <VeiledExperts-Win64-Shipping.exe+0xDD0CB0>
};
...
public:
	...
	int32_t ListenPort; // 0x250 (4)
	struct TArray<struct AOnlineBeaconClient> ClientActors; // 0x258 (16)
};
...
public:
	...
	struct FString BeaconTypeName; // 0x220 (16)
	struct UClass* ClientBeaconActorClass; // 0x230 (8)
	struct TArray<struct AOnlineBeaconClient> ClientActors; // 0x238 (16)
};
...
public:
	...
	bool bIsFromInvite; // 0x188 (1)
	bool bHandlingDisconnect; // 0x189 (1)
};
...
public:
	...
	struct FString DestSessionId; // 0x2E0 (16)
	struct FPartyReservation PendingReservation; // 0x2F0 (80)
	enum class EClientRequestType RequestType; // 0x340 (1)
	bool bPendingReservationSent; // 0x341 (1)
	bool bCancelReservation; // 0x342 (1)

	void ServerUpdateReservationRequest(struct FString SessionId, struct FPartyReservation ReservationUpdate); // Function OnlineSubsystemUtils.PartyBeaconClient.ServerUpdateReservationRequest(Net|NetReliableNative|Event|Protected|NetServer|NetValidate) // <VeiledExperts-Win64-Shipping.exe+0xDD1AC0>
	void ServerReservationRequest(struct FString SessionId, struct FPartyReservation Reservation); // Function OnlineSubsystemUtils.PartyBeaconClient.ServerReservationRequest(Net|NetReliableNative|Event|Protected|NetServer|NetValidate) // <VeiledExperts-Win64-Shipping.exe+0xDD1790>
	void ServerRemoveMemberFromReservationRequest(struct FString SessionId, struct FPartyReservation ReservationUpdate); // Function OnlineSubsystemUtils.PartyBeaconClient.ServerRemoveMemberFromReservationRequest(Net|NetReliableNative|Event|Protected|NetServer|NetValidate) // <VeiledExperts-Win64-Shipping.exe+0xDD1600>
	void ServerCancelReservationRequest(struct FUniqueNetIdRepl PartyLeader); // Function OnlineSubsystemUtils.PartyBeaconClient.ServerCancelReservationRequest(Net|NetReliableNative|Event|Protected|NetServer|NetValidate) // <VeiledExperts-Win64-Shipping.exe+0xDD14A0>
	void ClientSendReservationUpdates(int32_t NumRemainingReservations); // Function OnlineSubsystemUtils.PartyBeaconClient.ClientSendReservationUpdates(Net|NetReliableNative|Event|Public|NetClient) // <VeiledExperts-Win64-Shipping.exe+0xDD0E30>
	void ClientSendReservationFull(); // Function OnlineSubsystemUtils.PartyBeaconClient.ClientSendReservationFull(Net|NetReliableNative|Event|Public|NetClient) // <VeiledExperts-Win64-Shipping.exe+0xDD0DF0>
	void ClientReservationResponse(enum class EPartyReservationResult ReservationResponse); // Function OnlineSubsystemUtils.PartyBeaconClient.ClientReservationResponse(Net|NetReliableNative|Event|Public|NetClient) // <VeiledExperts-Win64-Shipping.exe+0xDD0CF0>
	void ClientCancelReservationResponse(enum class EPartyReservationResult ReservationResponse); // Function OnlineSubsystemUtils.PartyBeaconClient.ClientCancelReservationResponse(Net|NetReliableNative|Event|Public|NetClient) // <VeiledExperts-Win64-Shipping.exe+0xDD0BB0>
};
...
public:
	...
	struct UPartyBeaconState State; // 0x248 (8)
	bool bLogoutOnSessionTimeout; // 0x2B0 (1)
	float SessionTimeoutSecs; // 0x2B4 (4)
	float TravelSessionTimeoutSecs; // 0x2B8 (4)
};
...
public:
	...
	bool bRestrictCrossConsole; // 0x50 (1)
	bool bEnableRemovalRequests; // 0x51 (1)
...
public:
	...
	struct UQuitMatchCallbackProxy QuitMatch(struct Object WorldContextObject, struct APlayerController PlayerController, struct FString MatchID, enum class EMPMatchOutcome Outcome, int32_t TurnTimeoutInSeconds); // Function OnlineSubsystemUtils.QuitMatchCallbackProxy.QuitMatch(Final|Native|Static|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xDD12E0>
};
...
public:
	...
	struct UShowLoginUICallbackProxy ShowExternalLoginUI(struct Object WorldContextObject, struct APlayerController InPlayerController); // Function OnlineSubsystemUtils.ShowLoginUICallbackProxy.ShowExternalLoginUI(Final|Native|Static|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0xDD1C50>
};
...
public:
	...
	struct FString DestSessionId; // 0x2E0 (16)
	struct FSpectatorReservation PendingReservation; // 0x2F0 (120)
	enum class ESpectatorClientRequestType RequestType; // 0x368 (1)
	bool bPendingReservationSent; // 0x369 (1)
	bool bCancelReservation; // 0x36A (1)

	void ServerReservationRequest(struct FString SessionId, struct FSpectatorReservation Reservation); // Function OnlineSubsystemUtils.SpectatorBeaconClient.ServerReservationRequest(Net|NetReliableNative|Event|Protected|NetServer|NetValidate) // <VeiledExperts-Win64-Shipping.exe+0xDD1920>
	void ServerCancelReservationRequest(struct FUniqueNetIdRepl Spectator); // Function OnlineSubsystemUtils.SpectatorBeaconClient.ServerCancelReservationRequest(Net|NetReliableNative|Event|Protected|NetServer|NetValidate) // <VeiledExperts-Win64-Shipping.exe+0xDD14A0>
	void ClientSendReservationUpdates(int32_t NumRemainingReservations); // Function OnlineSubsystemUtils.SpectatorBeaconClient.ClientSendReservationUpdates(Net|NetReliableNative|Event|Public|NetClient) // <VeiledExperts-Win64-Shipping.exe+0xDD0EC0>
	void ClientSendReservationFull(); // Function OnlineSubsystemUtils.SpectatorBeaconClient.ClientSendReservationFull(Net|NetReliableNative|Event|Public|NetClient) // <VeiledExperts-Win64-Shipping.exe+0xDD0E10>
	void ClientReservationResponse(enum class ESpectatorReservationResult ReservationResponse); // Function OnlineSubsystemUtils.SpectatorBeaconClient.ClientReservationResponse(Net|NetReliableNative|Event|Public|NetClient) // <VeiledExperts-Win64-Shipping.exe+0xDD0D70>
	void ClientCancelReservationResponse(enum class ESpectatorReservationResult ReservationResponse); // Function OnlineSubsystemUtils.SpectatorBeaconClient.ClientCancelReservationResponse(Net|NetReliableNative|Event|Public|NetClient) // <VeiledExperts-Win64-Shipping.exe+0xDD0C30>
};
...
public:
	...
	struct USpectatorBeaconState State; // 0x248 (8)
	bool bLogoutOnSessionTimeout; // 0x2B0 (1)
	float SessionTimeoutSecs; // 0x2B4 (4)
	float TravelSessionTimeoutSecs; // 0x2B8 (4)
};
...
public:
	...
	int32_t NumConsumedReservations; // 0x30 (4)
	int32_t MaxReservations; // 0x34 (4)
	bool bRestrictCrossConsole; // 0x38 (1)
...
inline struct UCreateSessionCallbackProxy UCreateSessionCallbackProxy::CreateSession(struct Object WorldContextObject, struct APlayerController PlayerController, int32_t PublicConnections, bool bUseLAN) {
...
inline struct UEndMatchCallbackProxy UEndMatchCallbackProxy::EndMatch(struct Object WorldContextObject, struct APlayerController PlayerController, struct TScriptInterface<ITurnBasedMatchInterface> MatchActor, struct FString MatchID, enum class EMPMatchOutcome LocalPlayerOutcome, enum class EMPMatchOutcome OtherPlayersOutcome) {
	...
	struct EndMatch_Params {
		...
		enum class EMPMatchOutcome LocalPlayerOutcome;
		enum class EMPMatchOutcome OtherPlayersOutcome;
...
inline struct UFindSessionsCallbackProxy UFindSessionsCallbackProxy::FindSessions(struct Object WorldContextObject, struct APlayerController PlayerController, int32_t MaxResults, bool bUseLAN) {
...
inline struct UFindTurnBasedMatchCallbackProxy UFindTurnBasedMatchCallbackProxy::FindTurnBasedMatch(struct Object WorldContextObject, struct APlayerController PlayerController, struct TScriptInterface<ITurnBasedMatchInterface> MatchActor, int32_t MinPlayers, int32_t MaxPlayers, int32_t PlayerGroup, bool ShowExistingMatches) {
...
inline void APartyBeaconClient::ClientReservationResponse(enum class EPartyReservationResult ReservationResponse) {
	...
	struct ClientReservationResponse_Params {
		enum class EPartyReservationResult ReservationResponse;
...
inline void APartyBeaconClient::ClientCancelReservationResponse(enum class EPartyReservationResult ReservationResponse) {
...
inline struct UQuitMatchCallbackProxy UQuitMatchCallbackProxy::QuitMatch(struct Object WorldContextObject, struct APlayerController PlayerController, struct FString MatchID, enum class EMPMatchOutcome Outcome, int32_t TurnTimeoutInSeconds) {
	...
	struct QuitMatch_Params {
		...
		struct APlayerController PlayerController;
		struct FString MatchID;
		enum class EMPMatchOutcome Outcome;
...
inline void ASpectatorBeaconClient::ClientReservationResponse(enum class ESpectatorReservationResult ReservationResponse) {
	...
	struct ClientReservationResponse_Params {
		enum class ESpectatorReservationResult ReservationResponse;
	}; ClientReservationResponse_Params Params;
...
inline void ASpectatorBeaconClient::ClientCancelReservationResponse(enum class ESpectatorReservationResult ReservationResponse) {

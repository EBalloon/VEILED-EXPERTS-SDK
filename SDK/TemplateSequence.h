...
public:
	...
	struct FMovieSceneSequencePlaybackSettings PlaybackSettings; // 0x228 (20)
	struct UTemplateSequencePlayer SequencePlayer; // 0x240 (8)
	struct FSoftObjectPath TemplateSequence; // 0x248 (24)
	struct FTemplateSequenceBindingOverrideData BindingOverride; // 0x260 (12)

	void SetSequence(struct UTemplateSequence InSequence); // Function TemplateSequence.TemplateSequenceActor.SetSequence(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x120EDC0>
	void SetBinding(struct UActor Actor); // Function TemplateSequence.TemplateSequenceActor.SetBinding(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x120ED40>
	struct UTemplateSequence LoadSequence(); // Function TemplateSequence.TemplateSequenceActor.LoadSequence(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x120ED10>
	struct UTemplateSequencePlayer GetSequencePlayer(); // Function TemplateSequence.TemplateSequenceActor.GetSequencePlayer(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x120ECE0>
	struct UTemplateSequence GetSequence(); // Function TemplateSequence.TemplateSequenceActor.GetSequence(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x120ECB0>
};

...
struct FJoinabilitySettings {
	...
	bool bPublicSearchable; // 0x8 (1)
	bool bAllowInvites; // 0x9 (1)
	bool bJoinViaPresence; // 0xA (1)
	bool bJoinViaPresenceFriendsOnly; // 0xB (1)
...
struct FInterpCurvePointVector2D {
	...
	enum class EInterpCurveMode InterpMode; // 0x1C (1)
};
...
struct FInterpCurvePointVector {
	...
	enum class EInterpCurveMode InterpMode; // 0x28 (1)
};
...
struct FInterpCurvePointQuat {
	...
	enum class EInterpCurveMode InterpMode; // 0x40 (1)
};
...
struct FInterpCurvePointTwoVectors {
	...
	enum class EInterpCurveMode InterpMode; // 0x4C (1)
};
...
struct FInterpCurvePointLinearColor {
	...
	enum class EInterpCurveMode InterpMode; // 0x34 (1)
};
...
struct FFloatRangeBound {
	enum class ERangeBoundTypes Type; // 0x0 (1)
	float Value; // 0x4 (4)
};

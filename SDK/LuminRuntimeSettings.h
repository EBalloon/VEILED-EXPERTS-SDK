...
public:
	...
	bool bProtectedContent; // 0x49 (1)
	bool bManualCallToAppReady; // 0x4A (1)
	bool bUseMobileRendering; // 0x4B (1)
	bool bUseVulkan; // 0x4C (1)

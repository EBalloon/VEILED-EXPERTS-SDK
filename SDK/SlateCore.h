...
struct FSlateBrush {
	...
	enum class ESlateBrushDrawType DrawAs; // 0x6C (1)
	enum class ESlateBrushTileType tiling; // 0x6D (1)
	enum class ESlateBrushMirrorType Mirroring; // 0x6E (1)
	enum class ESlateBrushImageType ImageType; // 0x6F (1)
	char bIsDynamicallyLoaded : 1; // 0x80 (1)
	char pad_68_1 : 7; // 0x68 (1)
	char pad_69_0 : 1; // 0x69 (1)
	char bHasUObject : 1; // 0x80 (1)
};

// ScriptStruct SlateCore.SlateColor
struct FSlateColor {
	struct FLinearColor SpecifiedColor; // 0x0 (16)
	enum class ESlateColorStylingMode ColorUseRule; // 0x10 (1)
};
...
struct FFontOutlineSettings {
	...
	bool bSeparateFillAlpha; // 0x4 (1)
	bool bApplyOutlineToDropShadows; // 0x5 (1)
...
struct FSearchBoxStyle : FSlateWidgetStyle {
	...
	bool bLeftAlignButtons; // 0xA78 (1)
};
...
struct FCheckBoxStyle : FSlateWidgetStyle {
	enum class ESlateCheckBoxType CheckBoxType; // 0x8 (1)

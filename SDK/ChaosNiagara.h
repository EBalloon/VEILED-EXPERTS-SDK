...
public:
	...
	bool bGetExternalCollisionData; // 0xFD (1)
	bool DoSpatialHash; // 0xFE (1)
	...
	bool bApplyMaterialsFilter; // 0x128 (1)
	struct TSet<struct UPhysicalMaterial> ChaosBreakingMaterialSet; // 0x130 (80)
	bool bGetExternalBreakingData; // 0x180 (1)
	bool bGetExternalTrailingData; // 0x181 (1)

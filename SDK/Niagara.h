...
public:
	...
	struct UNiagaraComponent NiagaraComponent; // 0x220 (8)
	char bDestroyOnSystemFinish : 1; // 0x228 (1)

	void SetDestroyOnSystemFinish(bool bShouldDestroyOnSystemFinish); // Function Niagara.NiagaraActor.SetDestroyOnSystemFinish(Final|RequiredAPI|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1161F70>
	void OnNiagaraSystemFinished(struct UNiagaraComponent FinishedComponent); // Function Niagara.NiagaraActor.OnNiagaraSystemFinished(Final|Native|Private) // <VeiledExperts-Win64-Shipping.exe+0x1161B00>
};
...
public:
	...
	struct UNiagaraSystem Asset; // 0x408 (8)
	enum class ENiagaraTickBehavior TickBehavior; // 0x410 (1)
	struct FNiagaraUserRedirectionParameterStore OverrideParameters; // 0x418 (264)
	char bForceSolo : 1; // 0x520 (1)
	char pad_521_1 : 7; // 0x521 (1)
	char bAutoDestroy : 1; // 0x54C (1)
	char pad_522_1 : 7; // 0x522 (1)
	char pad_523_0 : 1; // 0x523 (1)
	char bRenderingEnabled : 1; // 0x54C (1)
	char pad_523_2 : 6; // 0x523 (1)
	char pad_524_0 : 2; // 0x524 (1)
	char bAutoManageAttachment : 1; // 0x54C (1)
	char pad_524_3 : 5; // 0x524 (1)
	char pad_525_0 : 3; // 0x525 (1)
	char bAutoAttachWeldSimulatedBodies : 1; // 0x54C (1)
	char pad_525_4 : 4; // 0x525 (1)
	float MaxTimeBeforeForceUpdateTransform; // 0x550 (4)
	struct FMulticastInlineDelegate OnSystemFinished; // 0x558 (16)
	struct TWeakObjectPtr<struct USceneComponent> AutoAttachParent; // 0x568 (8)
	struct FName AutoAttachSocketName; // 0x570 (8)
	enum class EAttachmentRule AutoAttachLocationRule; // 0x578 (1)
	enum class EAttachmentRule AutoAttachRotationRule; // 0x579 (1)
	enum class EAttachmentRule AutoAttachScaleRule; // 0x57A (1)

	void SetVariableVec4(struct FName InVariableName, struct FVector4& InValue); // Function Niagara.NiagaraComponent.SetVariableVec4(Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1163340>
	void SetVariableVec3(struct FName InVariableName, struct FVector InValue); // Function Niagara.NiagaraComponent.SetVariableVec3(Final|Native|Public|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1163270>
	void SetVariableVec2(struct FName InVariableName, struct FVector2D InValue); // Function Niagara.NiagaraComponent.SetVariableVec2(Final|Native|Public|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x11631B0>
	void SetVariableQuat(struct FName InVariableName, struct FQuat& InValue); // Function Niagara.NiagaraComponent.SetVariableQuat(Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x11630E0>
	void SetVariableObject(struct FName InVariableName, struct Object Object); // Function Niagara.NiagaraComponent.SetVariableObject(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1163020>
	void SetVariableMaterial(struct FName InVariableName, struct UMaterialInterface Object); // Function Niagara.NiagaraComponent.SetVariableMaterial(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1162F60>
	void SetVariableLinearColor(struct FName InVariableName, struct FLinearColor& InValue); // Function Niagara.NiagaraComponent.SetVariableLinearColor(Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1162E90>
	void SetVariableInt(struct FName InVariableName, int32_t InValue); // Function Niagara.NiagaraComponent.SetVariableInt(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1162DD0>
	void SetVariableFloat(struct FName InVariableName, float InValue); // Function Niagara.NiagaraComponent.SetVariableFloat(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1162D00>
	void SetVariableBool(struct FName InVariableName, bool InValue); // Function Niagara.NiagaraComponent.SetVariableBool(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1162C30>
	void SetVariableActor(struct FName InVariableName, struct UActor Actor); // Function Niagara.NiagaraComponent.SetVariableActor(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1162B70>
	void SetSeekDelta(float InSeekDelta); // Function Niagara.NiagaraComponent.SetSeekDelta(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1162AF0>
	void SetRenderingEnabled(bool bInRenderingEnabled); // Function Niagara.NiagaraComponent.SetRenderingEnabled(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1162A60>
	void SetPreviewLODDistance(bool bEnablePreviewLODDistance, float PreviewLODDistance); // Function Niagara.NiagaraComponent.SetPreviewLODDistance(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1162990>
	void SetPaused(bool bInPaused); // Function Niagara.NiagaraComponent.SetPaused(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1162900>
	void SetNiagaraVariableVec4(struct FString InVariableName, struct FVector4& InValue); // Function Niagara.NiagaraComponent.SetNiagaraVariableVec4(Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1162810>
	void SetNiagaraVariableVec3(struct FString InVariableName, struct FVector InValue); // Function Niagara.NiagaraComponent.SetNiagaraVariableVec3(Final|Native|Public|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1162720>
	void SetNiagaraVariableVec2(struct FString InVariableName, struct FVector2D InValue); // Function Niagara.NiagaraComponent.SetNiagaraVariableVec2(Final|Native|Public|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1162650>
	void SetNiagaraVariableQuat(struct FString InVariableName, struct FQuat& InValue); // Function Niagara.NiagaraComponent.SetNiagaraVariableQuat(Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1162570>
	void SetNiagaraVariableObject(struct FString InVariableName, struct Object Object); // Function Niagara.NiagaraComponent.SetNiagaraVariableObject(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1162110>
	void SetNiagaraVariableLinearColor(struct FString InVariableName, struct FLinearColor& InValue); // Function Niagara.NiagaraComponent.SetNiagaraVariableLinearColor(Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1162490>
	void SetNiagaraVariableInt(struct FString InVariableName, int32_t InValue); // Function Niagara.NiagaraComponent.SetNiagaraVariableInt(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x11623B0>
	void SetNiagaraVariableFloat(struct FString InVariableName, float InValue); // Function Niagara.NiagaraComponent.SetNiagaraVariableFloat(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x11622D0>
	void SetNiagaraVariableBool(struct FString InVariableName, bool InValue); // Function Niagara.NiagaraComponent.SetNiagaraVariableBool(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x11621F0>
	void SetNiagaraVariableActor(struct FString InVariableName, struct UActor Actor); // Function Niagara.NiagaraComponent.SetNiagaraVariableActor(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1162110>
	void SetMaxSimTime(float InMaxTime); // Function Niagara.NiagaraComponent.SetMaxSimTime(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1162090>
	void SetForceSolo(bool bInForceSolo); // Function Niagara.NiagaraComponent.SetForceSolo(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1162000>
	void SetDesiredAge(float InDesiredAge); // Function Niagara.NiagaraComponent.SetDesiredAge(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1161EF0>
	void SetCanRenderWhileSeeking(bool bInCanRenderWhileSeeking); // Function Niagara.NiagaraComponent.SetCanRenderWhileSeeking(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1161E60>
	void SetAutoDestroy(bool bInAutoDestroy); // Function Niagara.NiagaraComponent.SetAutoDestroy(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1161DD0>
	void SetAsset(struct UNiagaraSystem InAsset); // Function Niagara.NiagaraComponent.SetAsset(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1161D50>
	void SetAllowScalability(bool bAllow); // Function Niagara.NiagaraComponent.SetAllowScalability(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1161CC0>
	void SetAgeUpdateMode(enum class ENiagaraAgeUpdateMode InAgeUpdateMode); // Function Niagara.NiagaraComponent.SetAgeUpdateMode(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1161C40>
	void SeekToDesiredAge(float InDesiredAge); // Function Niagara.NiagaraComponent.SeekToDesiredAge(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1161BC0>
	void ResetSystem(); // Function Niagara.NiagaraComponent.ResetSystem(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1161BA0>
	void ReinitializeSystem(); // Function Niagara.NiagaraComponent.ReinitializeSystem(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1161B80>
	bool IsPaused(); // Function Niagara.NiagaraComponent.IsPaused(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x1161AD0>
	float GetSeekDelta(); // Function Niagara.NiagaraComponent.GetSeekDelta(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x1161AA0>
	bool GetPreviewLODDistanceEnabled(); // Function Niagara.NiagaraComponent.GetPreviewLODDistanceEnabled(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x1161A80>
	int32_t GetPreviewLODDistance(); // Function Niagara.NiagaraComponent.GetPreviewLODDistance(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x1161A60>
	struct TArray<struct FVector> GetNiagaraParticleValueVec3_DebugOnly(struct FString InEmitterName, struct FString InValueName); // Function Niagara.NiagaraComponent.GetNiagaraParticleValueVec3_DebugOnly(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x11617E0>
	struct TArray<float> GetNiagaraParticleValues_DebugOnly(struct FString InEmitterName, struct FString InValueName); // Function Niagara.NiagaraComponent.GetNiagaraParticleValues_DebugOnly(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1161920>
	struct TArray<struct FVector> GetNiagaraParticlePositions_DebugOnly(struct FString InEmitterName); // Function Niagara.NiagaraComponent.GetNiagaraParticlePositions_DebugOnly(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x11616F0>
	float GetMaxSimTime(); // Function Niagara.NiagaraComponent.GetMaxSimTime(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x11616C0>
	bool GetForceSolo(); // Function Niagara.NiagaraComponent.GetForceSolo(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x1161690>
	float GetDesiredAge(); // Function Niagara.NiagaraComponent.GetDesiredAge(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x1161660>
	struct UNiagaraDataInterface GetDataInterface(struct FString Name); // Function Niagara.NiagaraComponent.GetDataInterface(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x11615B0>
	struct UNiagaraSystem GetAsset(); // Function Niagara.NiagaraComponent.GetAsset(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x1161590>
	enum class ENiagaraAgeUpdateMode GetAgeUpdateMode(); // Function Niagara.NiagaraComponent.GetAgeUpdateMode(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x1161560>
	void AdvanceSimulationByTime(float SimulateTime, float TickDeltaSeconds); // Function Niagara.NiagaraComponent.AdvanceSimulationByTime(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x11614A0>
	void AdvanceSimulation(int32_t TickCount, float TickDeltaSeconds); // Function Niagara.NiagaraComponent.AdvanceSimulation(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x11613D0>
};
...
public:
	...
	bool SetGridFromMaxAxis; // 0xE0 (1)
...
public:
	...
	bool SetGridFromVoxelSize; // 0xE0 (1)
...
public:
	...
	bool bLocalSpace; // 0x28 (1)
	bool bDeterminism; // 0x29 (1)
	...
	char bInterpolatedSpawning : 1; // 0x148 (1)
	char pad_13C_1 : 7; // 0x13C (1)
	char pad_13D_0 : 1; // 0x13D (1)
	char bFixedBounds : 1; // 0x148 (1)
	char pad_13D_2 : 6; // 0x13D (1)
	char pad_13E_0 : 2; // 0x13E (1)
	char bUseMinDetailLevel : 1; // 0x148 (1)
	char pad_13E_3 : 5; // 0x13E (1)
	char pad_13F_0 : 3; // 0x13F (1)
	char bUseMaxDetailLevel : 1; // 0x148 (1)
	char pad_13F_4 : 4; // 0x13F (1)
	char pad_140_0 : 4; // 0x140 (1)
	char bOverrideGlobalSpawnCountScale : 1; // 0x148 (1)
	char pad_140_5 : 3; // 0x140 (1)
	char pad_141_0 : 5; // 0x141 (1)
	char bRequiresPersistentIDs : 1; // 0x148 (1)
	char pad_141_6 : 2; // 0x141 (1)
	...
	char bSimulationStagesEnabled : 1; // 0x1A8 (1)
	char pad_19E_1 : 7; // 0x19E (1)
	char pad_19F_0 : 1; // 0x19F (1)
	char bDeprecatedShaderStagesEnabled : 1; // 0x1A8 (1)
	char pad_19F_2 : 6; // 0x19F (1)
	char pad_1A0_0 : 2; // 0x1A0 (1)
	char bLimitDeltaTime : 1; // 0x1A8 (1)
	char pad_1A0_3 : 5; // 0x1A0 (1)
...
public:
	...
	bool bIsEnabled; // 0x2C (1)
	bool bMotionBlurEnabled; // 0x2D (1)
};
...
public:
	...
	char bUseInverseSquaredFalloff : 1; // 0x50 (1)
	char bAffectsTranslucency : 1; // 0x50 (1)
	char bOverrideRenderingEnabled : 1; // 0x50 (1)
...
public:
	...
	char bOverrideMaterials : 1; // 0x5C (1)
	char pad_59_1 : 7; // 0x59 (1)
	char pad_5A_0 : 1; // 0x5A (1)
	char bSortOnlyWhenTranslucent : 1; // 0x5C (1)
	char pad_5A_2 : 6; // 0x5A (1)
	struct TArray<struct FNiagaraMeshMaterialOverride> OverrideMaterials; // 0x60 (16)
	struct FVector2D SubImageSize; // 0x70 (8)
	char bSubImageBlend : 1; // 0x78 (1)
	char pad_73_1 : 7; // 0x73 (1)
	enum class ENiagaraMeshFacingMode FacingMode; // 0x7C (1)
	char bLockedAxisEnable : 1; // 0x80 (1)
	char pad_75_1 : 7; // 0x75 (1)
...
public:
	...
	void SetVectorParameter(struct FString InVariableName, struct FVector InValue); // Function Niagara.NiagaraParameterCollectionInstance.SetVectorParameter(Final|Native|Public|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x116ACE0>
	void SetVector4Parameter(struct FString InVariableName, struct FVector4& InValue); // Function Niagara.NiagaraParameterCollectionInstance.SetVector4Parameter(Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x116ABF0>
	void SetVector2DParameter(struct FString InVariableName, struct FVector2D InValue); // Function Niagara.NiagaraParameterCollectionInstance.SetVector2DParameter(Final|Native|Public|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x116AB20>
	void SetQuatParameter(struct FString InVariableName, struct FQuat& InValue); // Function Niagara.NiagaraParameterCollectionInstance.SetQuatParameter(Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x116A930>
	void SetIntParameter(struct FString InVariableName, int32_t InValue); // Function Niagara.NiagaraParameterCollectionInstance.SetIntParameter(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x116A850>
	void SetFloatParameter(struct FString InVariableName, float InValue); // Function Niagara.NiagaraParameterCollectionInstance.SetFloatParameter(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x116A770>
	void SetColorParameter(struct FString InVariableName, struct FLinearColor InValue); // Function Niagara.NiagaraParameterCollectionInstance.SetColorParameter(Final|Native|Public|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x116A690>
	void SetBoolParameter(struct FString InVariableName, bool InValue); // Function Niagara.NiagaraParameterCollectionInstance.SetBoolParameter(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x116A5B0>
	struct FVector GetVectorParameter(struct FString InVariableName); // Function Niagara.NiagaraParameterCollectionInstance.GetVectorParameter(Final|Native|Public|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x116A1C0>
	struct FVector4 GetVector4Parameter(struct FString InVariableName); // Function Niagara.NiagaraParameterCollectionInstance.GetVector4Parameter(Final|Native|Public|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x116A110>
	struct FVector2D GetVector2DParameter(struct FString InVariableName); // Function Niagara.NiagaraParameterCollectionInstance.GetVector2DParameter(Final|Native|Public|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x116A060>
	struct FQuat GetQuatParameter(struct FString InVariableName); // Function Niagara.NiagaraParameterCollectionInstance.GetQuatParameter(Final|Native|Public|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1169FB0>
	int32_t GetIntParameter(struct FString InVariableName); // Function Niagara.NiagaraParameterCollectionInstance.GetIntParameter(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1169E40>
	float GetFloatParameter(struct FString InVariableName); // Function Niagara.NiagaraParameterCollectionInstance.GetFloatParameter(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1169D90>
	struct FLinearColor GetColorParameter(struct FString InVariableName); // Function Niagara.NiagaraParameterCollectionInstance.GetColorParameter(Final|Native|Public|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1169CE0>
	bool GetBoolParameter(struct FString InVariableName); // Function Niagara.NiagaraParameterCollectionInstance.GetBoolParameter(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x1169C30>
};
...
public:
	...
	struct UNiagaraSystem System; // 0x220 (8)
	enum class ENiagaraPreviewGridResetMode ResetMode; // 0x228 (1)
	struct UNiagaraPreviewAxis PreviewAxisX; // 0x230 (8)
	struct UNiagaraPreviewAxis PreviewAxisY; // 0x238 (8)
	struct UClass* PreviewClass; // 0x240 (8)
	float SpacingX; // 0x248 (4)
	float SpacingY; // 0x24C (4)
	int32_t NumX; // 0x250 (4)
	int32_t NumY; // 0x254 (4)
	struct TArray<struct UChildActorComponent> PreviewComponents; // 0x258 (16)

	void SetPaused(bool bPaused); // Function Niagara.NiagaraPreviewGrid.SetPaused(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x116F0B0>
	void GetPreviews(struct TArray<struct UNiagaraComponent>& OutPreviews); // Function Niagara.NiagaraPreviewGrid.GetPreviews(Final|Native|Public|HasOutParms|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x116EFD0>
	void DeactivatePreviews(); // Function Niagara.NiagaraPreviewGrid.DeactivatePreviews(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x116EFB0>
	void ActivatePreviews(bool bReset); // Function Niagara.NiagaraPreviewGrid.ActivatePreviews(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x116EDB0>
};
...
public:
	...
	bool bUseConstantFactor; // 0xC0 (1)
	float TessellationAngle; // 0xC4 (4)
	bool bScreenSpaceTessellation; // 0xC8 (1)
...
public:
	...
	void RaiseOnGPUCompilationComplete(); // Function Niagara.NiagaraScript.RaiseOnGPUCompilationComplete(Final|Native|Public) // <VeiledExperts-Win64-Shipping.exe+0xFBCF20>
};
...
public:
	...
	char bSubImageBlend : 1; // 0x98 (1)
	char pad_93_1 : 7; // 0x93 (1)
	char pad_94_0 : 1; // 0x94 (1)
	char bRemoveHMDRollInVR : 1; // 0x98 (1)
	char pad_94_2 : 6; // 0x94 (1)
	char pad_95_0 : 2; // 0x95 (1)
	char bSortOnlyWhenTranslucent : 1; // 0x98 (1)
	char pad_95_3 : 5; // 0x95 (1)
...
public:
	...
	bool bDumpDebugSystemInfo; // 0x31 (1)
	bool bDumpDebugEmitterInfo; // 0x32 (1)
	char bFixedBounds : 1; // 0x34 (1)
	char pad_32_1 : 7; // 0x32 (1)
	struct UNiagaraEffectType EffectType; // 0x38 (8)
	bool bOverrideScalabilitySettings; // 0x40 (1)
...
struct FVMExternalFunctionBindingInfo {
	...
	struct TArray<bool> InputParamLocations; // 0x10 (16)
...
struct FNiagaraFunctionSignature {
	...
	char bRequiresContext : 1; // 0x30 (1)
	char bMemberFunction : 1; // 0x30 (1)
	char bExperimental : 1; // 0x30 (1)
	char bSupportsCPU : 1; // 0x30 (1)
	char bSupportsGPU : 1; // 0x30 (1)
	char bWriteFunction : 1; // 0x30 (1)
...
struct FNiagaraScriptDataUsageInfo {
	bool bReadsAttributeData; // 0x0 (1)
};
...
struct FNiagaraDataSetCompiledData {
	...
	char bRequiresPersistentIDs : 1; // 0x28 (1)
...
struct FNiagaraEmitterScalabilitySettings {
	...
	char bScaleSpawnCount : 1; // 0x20 (1)
	char pad_20_1 : 7; // 0x20 (1)
...
struct FNiagaraEmitterScalabilityOverride : FNiagaraEmitterScalabilitySettings {
	char bOverrideSpawnCountScale : 1; // 0x28 (1)
};
...
struct FNiagaraSystemScalabilitySettings {
	struct FNiagaraPlatformSet Platforms; // 0x0 (32)
	char bCullByDistance : 1; // 0x20 (1)
	char bCullMaxInstanceCount : 1; // 0x20 (1)
	char bCullByMaxTimeWithoutRender : 1; // 0x20 (1)
	char pad_20_3 : 5; // 0x20 (1)
...
struct FNiagaraSystemScalabilityOverride : FNiagaraSystemScalabilitySettings {
	char bOverrideDistanceSettings : 1; // 0x30 (1)
	char bOverrideInstanceCountSettings : 1; // 0x30 (1)
	char bOverrideTimeSinceRendererSettings : 1; // 0x30 (1)
};
...
struct FNiagaraEventScriptProperties : FNiagaraEmitterScriptProperties {
	...
	bool bRandomSpawnNumber; // 0x4C (1)
...
struct FSimulationStageMetaData {
	...
	char bSpawnOnly : 1; // 0x8 (1)
	char bWritesParticles : 1; // 0x8 (1)
...
struct FNiagaraVMExecutableDataId {
	...
	char bUsesRapidIterationParams : 1; // 0x24 (1)
	char pad_21_1 : 7; // 0x21 (1)
	char pad_22_0 : 1; // 0x22 (1)
	char bInterpolatedSpawn : 1; // 0x24 (1)
	char pad_22_2 : 6; // 0x22 (1)
	char pad_23_0 : 2; // 0x23 (1)
	char bRequiresPersistentIDs : 1; // 0x24 (1)
	char pad_23_3 : 5; // 0x23 (1)
...
struct FNiagaraVariableMetaData {
	...
	bool bAdvancedDisplay; // 0x30 (1)
	int32_t EditorSortPriority; // 0x34 (4)
	bool bInlineEditConditionToggle; // 0x38 (1)
	...
	bool bIsStaticSwitch; // 0xCC (1)
	int32_t StaticSwitchDefaultValue; // 0xD0 (4)
	bool bAddedToNodeGraphDeepCopy; // 0xD4 (1)
	bool bOutputIsPersistent; // 0xD5 (1)
	struct FName CachedNamespacelessVariableName; // 0xD8 (8)
	bool bCreatedInSystemEditor; // 0xE0 (1)
	bool bUseLegacyNameString; // 0xE1 (1)
};
...
inline void ANiagaraActor::SetDestroyOnSystemFinish(bool bShouldDestroyOnSystemFinish) {
...
inline void UNiagaraComponent::SetVariableBool(struct FName InVariableName, bool InValue) {
...
inline void UNiagaraComponent::SetRenderingEnabled(bool bInRenderingEnabled) {
...
inline void UNiagaraComponent::SetPreviewLODDistance(bool bEnablePreviewLODDistance, float PreviewLODDistance) {
...
inline void UNiagaraComponent::SetPaused(bool bInPaused) {
...
inline void UNiagaraComponent::SetNiagaraVariableBool(struct FString InVariableName, bool InValue) {
...
inline void UNiagaraComponent::SetForceSolo(bool bInForceSolo) {
...
inline void UNiagaraComponent::SetCanRenderWhileSeeking(bool bInCanRenderWhileSeeking) {
...
inline void UNiagaraComponent::SetAutoDestroy(bool bInAutoDestroy) {
...
inline void UNiagaraComponent::SetAllowScalability(bool bAllow) {
...
inline bool UNiagaraComponent::IsPaused() {
...
inline bool UNiagaraComponent::GetPreviewLODDistanceEnabled() {
...
inline bool UNiagaraComponent::GetForceSolo() {
...
inline void UNiagaraParameterCollectionInstance::SetBoolParameter(struct FString InVariableName, bool InValue) {
...
inline bool UNiagaraParameterCollectionInstance::GetBoolParameter(struct FString InVariableName) {
...
inline void ANiagaraPreviewGrid::SetPaused(bool bPaused) {
...
inline void ANiagaraPreviewGrid::ActivatePreviews(bool bReset) {

...
public:
	...
	void SetConstraintBindingID(struct FMovieSceneObjectBindingID& InConstraintBindingID); // Function MovieSceneTracks.MovieScene3DConstraintSection.SetConstraintBindingID(Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure) // <VeiledExperts-Win64-Shipping.exe+0x2935BF0>
	struct FMovieSceneObjectBindingID GetConstraintBindingID(); // Function MovieSceneTracks.MovieScene3DConstraintSection.GetConstraintBindingID(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x2935B70>
};
...
public:
	...
	char bFollow : 1; // 0x1AC (1)
	char pad_1AA_1 : 7; // 0x1AA (1)
	char pad_1AB_0 : 1; // 0x1AB (1)
	char bReverse : 1; // 0x1AC (1)
	char pad_1AB_2 : 6; // 0x1AB (1)
	char pad_1AC_0 : 2; // 0x1AC (1)
	char bForceUpright : 1; // 0x1AC (1)
};
...
public:
	...
	bool bUseQuaternionInterpolation; // 0x72C (1)
};
...
public:
	...
	bool bSuppressSubtitles; // 0x2F0 (1)
	bool bOverrideAttenuation; // 0x2F1 (1)
	...
	void SetStartOffset(struct FFrameNumber InStartOffset); // Function MovieSceneTracks.MovieSceneAudioSection.SetStartOffset(Final|Native|Public|HasDefaults|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2935D30>
	void SetSound(struct USoundBase InSound); // Function MovieSceneTracks.MovieSceneAudioSection.SetSound(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2935CB0>
	struct FFrameNumber GetStartOffset(); // Function MovieSceneTracks.MovieSceneAudioSection.GetStartOffset(Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x2935BD0>
	struct USoundBase GetSound(); // Function MovieSceneTracks.MovieSceneAudioSection.GetSound(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x2935BB0>
};
...
public:
	...
	void SetCameraBindingID(struct FMovieSceneObjectBindingID& InCameraBindingID); // Function MovieSceneTracks.MovieSceneCameraCutSection.SetCameraBindingID(Final|Native|Public|HasOutParms|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x2935BF0>
	struct FMovieSceneObjectBindingID GetCameraBindingID(); // Function MovieSceneTracks.MovieSceneCameraCutSection.GetCameraBindingID(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x2935B70>
};
...
public:
	...
	enum class ECameraAnimPlaySpace PlaySpace; // 0x10C (1)
...
public:
	...
	void SetShotDisplayName(struct FString InShotDisplayName); // Function MovieSceneTracks.MovieSceneCinematicShotSection.SetShotDisplayName(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x293C740>
	struct FString GetShotDisplayName(); // Function MovieSceneTracks.MovieSceneCinematicShotSection.GetShotDisplayName(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x293C5A0>
};
...
public:
	...
	char bFireEventsWhenForwards : 1; // 0x58 (1)
	char bFireEventsWhenBackwards : 1; // 0x58 (1)
...
public:
	...
	void SetVisibility(enum class ELevelVisibility InVisibility); // Function MovieSceneTracks.MovieSceneLevelVisibilitySection.SetVisibility(Final|Native|Public|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x293C830>
	void SetLevelNames(struct TArray<struct FName>& InLevelNames); // Function MovieSceneTracks.MovieSceneLevelVisibilitySection.SetLevelNames(Final|Native|Public|HasOutParms|BlueprintCallable) // <VeiledExperts-Win64-Shipping.exe+0x293C690>
	enum class ELevelVisibility GetVisibility(); // Function MovieSceneTracks.MovieSceneLevelVisibilitySection.GetVisibility(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x293C660>
	struct TArray<struct FName> GetLevelNames(); // Function MovieSceneTracks.MovieSceneLevelVisibilitySection.GetLevelNames(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <VeiledExperts-Win64-Shipping.exe+0x293C570>
};
...
public:
	...
	char bReverse : 1; // 0x1D4 (1)
	char pad_1D4_1 : 7; // 0x1D4 (1)
...
public:
	...
	bool bUseLegacySectionIndexBlend; // 0x68 (1)
};
...
struct FMovieScene3DPathSectionTemplate : FMovieSceneEvalTemplate {
	...
	char bFollow : 1; // 0xDC (1)
	char pad_DA_1 : 7; // 0xDA (1)
	char pad_DB_0 : 1; // 0xDB (1)
	char bReverse : 1; // 0xDC (1)
	char pad_DB_2 : 6; // 0xDB (1)
	char pad_DC_0 : 2; // 0xDC (1)
	char bForceUpright : 1; // 0xDC (1)
};
...
struct FMovieScene3DTransformTemplateData {
	...
	bool bUseQuaternionInterpolation; // 0x648 (1)
};
...
struct FMovieSceneCameraShakeSectionData {
	...
	enum class ECameraAnimPlaySpace PlaySpace; // 0xC (1)
...
struct FMovieSceneCameraCutSectionTemplate : FMovieSceneEvalTemplate {
	...
	bool bHasCutTransform; // 0x70 (1)
	bool bIsFinalSection; // 0x71 (1)
};
...
struct FMovieSceneEventTemplateBase : FMovieSceneEvalTemplate {
	...
	char bFireEventsWhenForwards : 1; // 0x30 (1)
	char bFireEventsWhenBackwards : 1; // 0x30 (1)
};
